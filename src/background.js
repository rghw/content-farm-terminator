...
// returns a Promise if updateFilter is not yet completed.
// (Available for Firefox >= 52)
// When updateFilter is completed, this will be replaced by 
